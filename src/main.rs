...
fn main() {
    ...
    // example::decoder_rbg_apng::handel("pngs/apng_test_1.png");
    ...
    example::imagequant_handle::apng_imagequant_handle("pngs/apng_rgb.png");
    // example::imagequant_handle::apng_imagequant_handle("pngs/apng_test_1.png");
}
